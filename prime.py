...
def yieldPrimes(primesSoFar):
        curPrimeList=primesSoFar[:]
        candidate=2
        while True:
                if not listHasFactor(curPrimeList, candidate):
                        yield candidate
...
def smartPrimesBetween(a,b,primesUnderA):
        rangeBetween=range(a,b)
        setBetween=set(rangeBetween)
        rangeToB=range(b)
        for i in primesUnderA:
                elimMults(setBetween,i,b)
        for i in rangeBetween:
                if i in setBetween:
                        elimMults(setBetween, i, b)
        return setBetween
...
if __name__ == "__main__":
        ...
        #    if x>20204:
        #        break
        under100 = smartPrimesUnder(100)
        print under100
        under30 = smartPrimesUnder(30)
        print smartPrimesBetween(30,100,under30)
        print under100.difference(under30)
        print smartPrimesBetween(30,100,under30)==under100.difference(under30)
